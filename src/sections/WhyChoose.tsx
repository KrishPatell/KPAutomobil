...
function Yes() {
  return (
    <svg
      aria-hidden="true"
      className="kp-compare-mark kp-compare-mark--yes"
      fill="none"
      height="21.59"
...
function No() {
  return (
    <svg
      aria-hidden="true"
      className="kp-compare-mark kp-compare-mark--no"
      fill="none"
      height="21.59"
      viewBox="0 0 21.59 21.59"
      width="21.59"
  ...
  return (
    ...
    >
      <div className="kp-why__head kp-reveal" ref={headRef}>
        ...
        <p className="kp-why__intro kp-reveal" style={revealDelay(2)}>
          {compare.intro}
        </p>
      </div>
      ...
      <div className="kp-why__scroll kp-reveal" ref={tableRef}>
        <table className="kp-why__table">
          <caption className="kp-visually-hidden">{compare.heading}</caption>
          <thead>
            <tr>
              <th scope="col">{compare.featureLabel}</th>
              <th className="kp-why__col--kp" scope="col">
