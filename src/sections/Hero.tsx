...
export default function Hero({ onExplore }: HeroProps) {
  ...
  return (
    <section
      ...
      id="top"
      ref={revealRef}
      aria-label="KP Automobil"
    >
      <img
        className="kp-hero__image"
        src={heroImage}
        alt=""
        aria-hidden="true"
      />
        ...
        <div className="kp-hero__copy">
          <p className="kp-hero__pill kp-reveal">
            <svg aria-hidden="true" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 21s7-5.24 7-12A7 7 0 1 0 5 9c0 6.76 7 12 7 12Z"
                stroke="currentColor"
                strokeWidth="1.7"
              />
              <circle
          ...
          <div className="kp-hero__actions kp-reveal" style={revealDelay(3)}>
            <KpButton size="md" onClick={onExplore}>
              {hero.cta}
            </KpButton>
          </div>
        </div>
        ...
        <aside className="kp-hero__proof kp-reveal" style={revealDelay(4)}>
          ...
          <div className="kp-hero__proof-body">
            <p className="kp-hero__proof-figure">
              {hero.proof.figure}
              <span>{hero.proof.figureUnit}</span>
            </p>
