    ...
    >
      <div className="kp-book__grid">
        <div className="kp-book__head kp-reveal" ref={headRef}>
          ...
          <p className="kp-book__lede kp-reveal" style={revealDelay(2)}>
            {booking.intro}
          </p>
        ...
        <div className="kp-book__panel kp-reveal" ref={formRef}>
          <form className="kp-book__form" onSubmit={onSubmit}>
            <label className="kp-field">
              <span className="kp-field__label">
            ...
            <label className="kp-field">
              ...
              <span className="kp-field__hint">
                {booking.fields.email.hint}
              </span>
            </label>

            <label className="kp-field">
              <span className="kp-field__label">
                {booking.fields.size.label}
              </span>
              <select
                name="size"
              ...
              >
                <option disabled value="">
                  {booking.fields.size.placeholder}
                </option>
                {sizes.map((item) => (
            ...
            <label className="kp-field kp-field--wide">
              ...
              >
                <option disabled value="">
                  {booking.fields.service.placeholder}
                </option>
                {packages.map((item) => (
            ...
            <label className="kp-field">
              <span className="kp-field__label">
                {booking.fields.window.label}
              </span>
              <select
                defaultValue={draft.window || booking.windows[0]}
                name="window"
              >
