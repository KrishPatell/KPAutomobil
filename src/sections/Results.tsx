...
export default function Results() {
  ...
  return (
    <section
      ...
      className="kp-section kp-results"
      id="results"
      ref={revealRef}
    >
      <div className="kp-section__inner">
        ...
        <div className="kp-results__head">
          ...
          <h2
            className="kp-section__title kp-reveal"
            id="results-heading"
            style={revealDelay(1)}
          >
            {results.heading}
          </h2>
          <p className="kp-results__intro kp-reveal" style={revealDelay(2)}>
            {results.intro}
          </p>
        </div>
        ...
        <figure className="kp-results__figure kp-reveal" style={revealDelay(3)}>
          ...
          >
            ...
            <span
              className="kp-compare__tag kp-compare__tag--before"
              style={{ opacity: split < 14 ? 0 : 1 }}
            >
              {results.beforeLabel}
            </span>
            <span
              className="kp-compare__tag kp-compare__tag--after"
              style={{ opacity: split > 86 ? 0 : 1 }}
            >
              {results.afterLabel}
            </span>
        ...
        {many && (
          <div className="kp-results__controls">
            <button
              aria-label={results.prevLabel}
              className="kp-results__arrow"
              onClick={() => step(-1)}
              type="button"
            >
              ‹
