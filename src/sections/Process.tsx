    ...
    >
      <div className="kp-process__grid">
        ...
        <div className="kp-process__panel">
          <img
            alt={process.panelImageAlt}
            className="kp-process__panel-img"
            src={process.panelImage}
          />
          ...
          <div className="kp-process__panel-body kp-reveal" ref={panelRef}>
            ...
            <div className="kp-process__foot">
              <p className="kp-process__intro kp-reveal" style={revealDelay(2)}>
                {process.intro}
              </p>
