...
export const PHOTO_SLOTS = [
  {
    ...
    hint: "Stand at a corner so one side and the front are both in frame.",
  },
  {
    id: "rear",
    label: "Rear three-quarter",
    hint: "The opposite corner, so between the two you have all four sides.",
  },
  {
    id: "cabin",
    label: "Front cabin",
    hint: "Driver's door open, seats and carpet visible.",
  },
  {
    id: "back-seat",
    label: "Rear seats or boot",
    hint: "Wherever the mess actually is — that is what sets the time.",
  },
] as const
...
export function validate(file: File): string | null {
  if (file.size > MAX_BYTES)
    return "That photo is over 12MB. A normal phone shot is well under."
