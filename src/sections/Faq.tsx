...
function Row({
  ...
  return (
    <div
      className={`kp-faq__row kp-reveal${isOpen ? " kp-faq__row--open" : ""}`}
      ref={revealRef}
    ...
    >
      <h3 className="kp-faq__q">
        ...
        >
          ...
          <span aria-hidden="true" className="kp-faq__plus">
            +
          </span>
        </button>
      </h3>
    ...
    >
      <div className="kp-faq__grid">
        <div className="kp-faq__head kp-reveal" ref={headRef}>
          ...
          <p className="kp-faq__lede kp-reveal" style={revealDelay(2)}>
            {faq.intro}
          </p>
        </div>
