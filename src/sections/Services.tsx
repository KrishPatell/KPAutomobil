...
export default function Services({ onBook }: ServicesProps) {
  ...
  return (
    <section
      ...
      className="kp-section kp-services"
      id="services"
      ref={revealRef}
    >
      <div className="kp-section__inner">
        <header className="kp-services__head">
          ...
          <p className="kp-services__intro kp-reveal" style={revealDelay(2)}>
            {services.intro}
          </p>
        </header>
          ...
          >
            <div className="kp-services__top">
              <div className="kp-services__summary">
                ...
                <KpButton onClick={() => onBook(pkg.title)} size="md">
                  Book Now
                </KpButton>
              </div>
            ...
            <div className="kp-services__included">
              <p className="kp-services__included-label">
                {services.includedLabel}
              </p>
